...
public partial class AdvanceApproved : System.Web.UI.Page
{
    ...
    public void approved()
    {
        ...
        string query = "";
            ...
            query = "select AdvanceId,FName + ' '+Lname 'Name',EA.EnterDate,EA.Amount,EA.Remarks,EA.DueDate,EA.ManagerStatus,EA.DepartmentHeadStatus,EA.HRStatus from EmployeeAdvanceTB EA left outer join EmployeeTB E on EA.EmployeeId=E.EmployeeId where EA.DepartmentHeadStatus = 'Approved' order by EA.EnterDate desc";
