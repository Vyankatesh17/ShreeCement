<%@ Page Title="Delete Photo In Device" Language="C#" MasterPageFile="~/UserMaster.master" AutoEventWireup="true" CodeFile="Delete_Device_Photo.aspx.cs" Inherits="Delete_Device_Photo" %>
                ...
                <div class="col-lg-12">
                    <div class="box box-primary">
                        <div class="box-header">
                            <h3 class="box-title">Delete Device Photo</h3>
                        </div>
                        <div class="box-body">
                            <div class="row">
                               ...
                               <div class="form-group col-md-2">
                                ...
                                <div class="form-group col-md-1">
                                    ...
                                    <div class="">
                                        ...
                                        <asp:Button ID="btnImport" runat="server" CssClass="btn btn-primary" ValidationGroup="A" Text="Delete photo" OnClick="btnImport_Click" />
                                    </div>
                                </div>
