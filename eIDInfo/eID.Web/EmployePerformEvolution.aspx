<%@ Page Title="Employee Perform Evolution" Language="C#" MasterPageFile="~/UserMaster.master" AutoEventWireup="true"
    CodeFile="EmployePerformEvolution.aspx.cs" Inherits="EmployePerformEvolution" %>
        ...
        <ContentTemplate>
            ...
            <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
                <asp:View ID="View1" runat="server">
                    <div class="pull-left">
                        <asp:UpdatePanel ID="updbtnadd" runat="server">
                            <Triggers>
                        ...
                        <table width="95%">
                                ...
                                <td>
                                    ...
                                    &nbsp;
                                                                 <asp:Button ID="btnPrint" runat="server" CssClass="btn bg-blue-active"
                                                                     Text="Print Blank Form" OnClick="btnPrint_Click" />
                                </td>
                            ...
                            <tr>
                                <td align="right">
                                    ...
                                    <%-- <asp:Label ID="lbl1" runat="server" CssClass="countStylelable" Text="No. of Counts :"> </asp:Label>
                                                                <asp:Label ID="lblcnt" runat="server" CssClass="countStyle">0</asp:Label>
                                                           </div>--%>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:GridView ID="grd_EmpPerformance" runat="server" AutoGenerateColumns="False"
                                        CssClass="table table-bordered table-striped" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black"
                                        GridLines="Vertical" AllowPaging="true" PageSize="10" OnPageIndexChanging="grd_EmpPerformance_PageIndexChanging"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Action" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="50px" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="View" runat="server" CommandArgument='<%# Eval("EvolutionID") %>'
                                                        Height="25px" ImageUrl="~/Images/View.png" Width="25px" ToolTip="View All Details" OnClick="View_Click" />
                                                </ItemTemplate>
                                ...
                                <table cellpadding="3" cellspacing="3" width="50%">
                                    <tr>
                                        <td>
                                            ...
                                            <asp:Panel ID="pasn1" runat="server" DefaultButton="btnsave">
                                                <table width="100%">
                                                    <tr>
                                                 ...
                                                 <asp:Label ID="Label4" runat="server" ForeColor="Red" Text="*"></asp:Label>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtdateeval" runat="server" CssClass="form-control" BackColor="White"></asp:TextBox>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtEmpPosition" runat="server" CssClass="form-control" BackColor="White" ReadOnly="True"></asp:TextBox>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td valign="top">
                                                            <asp:DropDownList ID="ddlevaluater" runat="server" AutoPostBack="True" CssClass="form-control">
                                                            </asp:DropDownList>
                    ...
                    <section class="content">
                        ...
                        <div class="col-md-12">
                            <div class="box box-primary">
                                                    ...
                                                    <table width="100%" style="border: 1px solid black;">
                                                        <tr>
                                                            <td>1) Knowledge of Work -
                                                                ...
                                                                <br />
                                                                <asp:RadioButtonList ID="RadioButtonList1" runat="server" Width="700px" RepeatDirection="Horizontal">
                                                ...
                                                <table width="100%" style="border: 1px solid black;">
                                                    <tr>
                                                        <td>2) Customer Responsiveness -
                                                            ...
                                                            <br />
                                                            <asp:RadioButtonList ID="RadioButtonList2" Width="700px" runat="server" RepeatDirection="Horizontal">
                                                                <asp:ListItem Selected="True" Value="5">Outstanding</asp:ListItem>
                                                                <asp:ListItem Value="4">Exceeds Expectations</asp:ListItem>
                                                                <asp:ListItem Value="3">Meets Expectations</asp:ListItem>
                                                                <asp:ListItem Value="2">Below Expectations</asp:ListItem>
                                                    ...
                                                    <tr>
                                                        <td>3) QUALITY OF WORK:<br />
                                                            ...
                                                            Performs work accurately, completely and precisely. Meets deadlines.
                                                                        <br />
                                                            <br />
                                                            <asp:RadioButtonList ID="RadioButtonList3" Width="700px" runat="server" RepeatDirection="Horizontal">
                                                                <asp:ListItem Selected="True" Value="5">Outstanding</asp:ListItem>
                                                                <asp:ListItem Value="4">Exceeds Expectations</asp:ListItem>
                                                                <asp:ListItem Value="3">Meets Expectations</asp:ListItem>
                                                                <asp:ListItem Value="2">Below Expectations</asp:ListItem>
                                                    ...
                                                    <tr>
                                                        <td>4) Job Knowledge -<br />
                                                            ...
                                                            remaining current on new developments affecting SPSU and its work activities.
                                                                        <br />
                                                            <br />
                                                            <asp:RadioButtonList ID="RadioButtonList4" Width="700px" runat="server" RepeatDirection="Horizontal">
                                                                <asp:ListItem Selected="True" Value="5">Outstanding</asp:ListItem>
                                                                <asp:ListItem Value="4">Exceeds Expectations</asp:ListItem>
                                                                <asp:ListItem Value="3">Meets Expectations</asp:ListItem>
                                                                <asp:ListItem Value="2">Below Expectations</asp:ListItem>
                                                    ...
                                                    <tr>
                                                        <td>5) ATTENDANCE:<br />
                                                            ...
                                                            Attends work each day unless on approved leave, such as vacation leave, sick leave,
                                                                        ...
                                                                        <br />
                                                            <br />
                                                            <asp:RadioButtonList ID="RadioButtonList5" Width="700px" runat="server" RepeatDirection="Horizontal">
                                                                <asp:ListItem Selected="True" Value="5">Outstanding</asp:ListItem>
                                                                <asp:ListItem Value="4">Exceeds Expectations</asp:ListItem>
                                                                <asp:ListItem Value="3">Meets Expectations</asp:ListItem>
                                                                <asp:ListItem Value="2">Below Expectations</asp:ListItem>
                                                    ...
                                                    <tr>
                                                        <td>6) WRITTEN AND ORAL COMMUNICATION:<br />
                                                            ...
                                                            Writes and speaks clearly, accurately and concisely using correct vocabulary, spelling
                                                                        ...
                                                                        <br />
                                                            <br />
                                                            <asp:RadioButtonList ID="RadioButtonList6" Width="700px" runat="server" RepeatDirection="Horizontal">
                                                                <asp:ListItem Selected="True" Value="5">Outstanding</asp:ListItem>
                                                                <asp:ListItem Value="4">Exceeds Expectations</asp:ListItem>
                                                                <asp:ListItem Value="3">Meets Expectations</asp:ListItem>
                                                                <asp:ListItem Value="2">Below Expectations</asp:ListItem>
                                                    ...
                                                    <tr>
                                                        <td>7) JUDGMENT/DECISION MAKING ABILITY:<br />
                                                            ...
                                                            Makes the right, correct decisions in a timely manner. Recognizes the distinction
                                                                        ...
                                                                        <br />
                                                            <br />
                                                            <asp:RadioButtonList ID="RadioButtonList7" Width="700px" runat="server" RepeatDirection="Horizontal">
                                                                <asp:ListItem Selected="True" Value="5">Outstanding</asp:ListItem>
                                                                <asp:ListItem Value="4">Exceeds Expectations</asp:ListItem>
                                                                <asp:ListItem Value="3">Meets Expectations</asp:ListItem>
                                                                <asp:ListItem Value="2">Below Expectations</asp:ListItem>
                                                    ...
                                                    <tr>
                                                        <td>8) INDUSTRIOUSNESS:<br />
                                                            ...
                                                            Displays initiative. Is willing and able to work hard
                                                                        <br />
                                                            <br />
                                                            <asp:RadioButtonList ID="RadioButtonList8" Width="700px" runat="server" RepeatDirection="Horizontal">
                                                                <asp:ListItem Selected="True" Value="5">Outstanding</asp:ListItem>
                                                                <asp:ListItem Value="4">Exceeds Expectations</asp:ListItem>
                                                                <asp:ListItem Value="3">Meets Expectations</asp:ListItem>
                                                                <asp:ListItem Value="2">Below Expectations</asp:ListItem>
                                                    ...
                                                    <tr>
                                                        <td>9) COOPERATION WITH CO-WORKERS:<br />
                                                            ...
                                                            Works as a team member. Relates well with co-workers and assists them when asked.
                                                                        <br />
                                                            <br />
                                                            <asp:RadioButtonList ID="RadioButtonList9" Width="700px" runat="server" RepeatDirection="Horizontal">
                                                                <asp:ListItem Selected="True" Value="5">Outstanding</asp:ListItem>
                                                                <asp:ListItem Value="4">Exceeds Expectations</asp:ListItem>
                                                                <asp:ListItem Value="3">Meets Expectations</asp:ListItem>
                                                                <asp:ListItem Value="2">Below Expectations</asp:ListItem>
                                                    ...
                                                    <tr>
                                                        <td>10) PUNCTUALITY:
                                                            ...
                                                            Arrives on time at the start of the workday. Does not abuse breaks or lunch periods
                                                                        ...
                                                                        <br />
                                                            <br />
                                                            <asp:RadioButtonList ID="RadioButtonList10" Width="700px" runat="server" RepeatDirection="Horizontal">
                                                                <asp:ListItem Selected="True" Value="5">Outstanding</asp:ListItem>
                                                                <asp:ListItem Value="4">Exceeds Expectations</asp:ListItem>
                                                                <asp:ListItem Value="3">Meets Expectations</asp:ListItem>
                                                                <asp:ListItem Value="2">Below Expectations</asp:ListItem>
                                                    ...
                                                    <tr>
                                                        <td>11) QUANTITY OF WORK:
                                                            ...
                                                            Performs a satisfactory volume of work during a given period of time.
                                                                        <br />
                                                            <br />
                                                            <asp:RadioButtonList ID="RadioButtonList11" Width="700px" runat="server" RepeatDirection="Horizontal">
                                                                <asp:ListItem Selected="True" Value="5">Outstanding</asp:ListItem>
                                                                <asp:ListItem Value="4">Exceeds Expectations</asp:ListItem>
                                                                <asp:ListItem Value="3">Meets Expectations</asp:ListItem>
                                                                <asp:ListItem Value="2">Below Expectations</asp:ListItem>
                                                    ...
                                                    <tr>
                                                        <td>12) COOPERATION WITH SUPERVISOR:
                                                            ...
                                                            Works with supervisor in carrying out tasks and following instructions.
                                                                        <br />
                                                            <br />
                                                            <asp:RadioButtonList ID="RadioButtonList12" Width="700px" runat="server" RepeatDirection="Horizontal">
                                                                <asp:ListItem Selected="True" Value="5">Outstanding</asp:ListItem>
                                                                <asp:ListItem Value="4">Exceeds Expectations</asp:ListItem>
                                                                <asp:ListItem Value="3">Meets Expectations</asp:ListItem>
                                                                <asp:ListItem Value="2">Below Expectations</asp:ListItem>
                                                    ...
                                                    <tr>
                                                        <td>Supervisor Comments Relative to Performance Evaluation:<br />
                                                            (Attach additional pages if required.) General Comments: &nbsp; &nbsp; &nbsp;
                                                                        <asp:TextBox ID="txtsupervisorcomment" runat="server" TextMode="MultiLine" Height="100px"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </table>
                                                <table cellpadding="2" cellspacing="2" width="100%" style="border: 1px solid black;">
                                                    <tr>
                                                        <td>Employee Comments Relative to Performance Evaluation:<br />
                                                            (Attach additional pages if required.) General Comments: &nbsp; &nbsp; &nbsp;
                                                                        <asp:TextBox ID="txtEmployeeComent" runat="server" TextMode="MultiLine" Height="100px"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </fieldset>
                                ...
                                <asp:Panel ID="panel4" runat="server" DefaultButton="btnsave" Width="90%">
                                    &nbsp;&nbsp;
                                                <table width="100%" style="border: 1px solid black">
                                                    <tr>
                                                        ...
                                                        <td colspan="2">
                                                            ...
                                                            <table width="100%">
                                                                <tr>
                                                                    ...
                                                                    <td valign="top">
                                                                        <asp:TextBox ID="Txtdate" runat="server" Width="60%" CssClass="form-control" BackColor="White"></asp:TextBox>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td valign="top">
                                                                        <asp:TextBox ID="TextBox4" runat="server" Width="60%" CssClass="form-control"></asp:TextBox>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtdate1" runat="server" Width="60%" CssClass="form-control" BackColor="White"></asp:TextBox>
                                ...
                                <asp:UpdatePanel ID="updddda" runat="server">
                                    <ContentTemplate>
                                        <asp:Panel ID="panel5" runat="server" DefaultButton="btnsave" Width="90%" Height="30%">
                                            <table width="100%" style="border: 1px solid black;">
                                                <tr>
                                                ...
                                                <tr>
                                                    <td style="width: 350px">
                                                        ...
                                                        &nbsp;&nbsp; </td>
                                                    <td>
                                                        <asp:TextBox ID="Text5" runat="server" Width="60%" CssClass="form-control"></asp:TextBox>
                                                    ...
                                                    <td valign="top">
                                                        <asp:TextBox ID="txtdate2" runat="server" Width="60%" BackColor="White" CssClass="form-control"></asp:TextBox>
                                ...
                                <asp:Panel ID="panel6" runat="server" DefaultButton="btnsave">
                                    <table width="100%">
                                        <tr>
                                            <td width="314px"></td>
                                            <td align="left">
                                                <asp:Button ID="btnsave" runat="server" Text="Save" Height="35px" CssClass="btn bg-blue-active"
                                                    OnClick="btnsave_Click2" ValidationGroup="a" />
                                                <asp:Button ID="btncancel" runat="server" Text="Cancel" CssClass="btn bg-blue-active"
                                                    Height="35px" OnClick="btncancel_Click1" />
                                            </td>
                                        </tr>
                                    </table>
                                </asp:Panel>
