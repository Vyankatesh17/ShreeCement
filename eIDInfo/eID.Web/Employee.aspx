<%@ Page Title="Employee" Language="C#" MasterPageFile="~/UserMaster.master" AutoEventWireup="true"
    CodeFile="Employee.aspx.cs" Inherits="_Default" %>
                            ...
                            <div class="box">
                                <div class="box-header with-border">
                                    ...
                                    <div class="box-tools">
                                        ...
                                        <asp:Button ID="btnImport" runat="server" CssClass="btn btn-box-tool btn-github" Text="Import Employee" />
                                    </div>
                                </div>
                                <div class="box-body">
                                    <div class="row">
                                                ...
                                                <asp:TemplateField HeaderText="Action">
                                                    <ItemTemplate>
                                                        <div class="btn-group" style="min-width: 100px;">
                                                            <asp:LinkButton ID="lbtnView" runat="server" OnClick="lbtnView_Click" CommandArgument='<%#Eval("EmployeeId") %>' CssClass="btn btn-sm btn-info"><i class="fa fa-eye"></i></asp:LinkButton>
                                                            <asp:LinkButton ID="lbtnEdit" runat="server" OnClick="lbtnEdit_Click" CommandArgument='<%#Eval("EmployeeId") %>' CssClass="btn btn-sm btn-warning"><i class="fa fa-edit"></i></asp:LinkButton>
                                                            <asp:LinkButton ID="lbtnRelease" runat="server" OnClick="lbtnRelease_Click" CommandArgument='<%#Eval("EmployeeId") %>' CssClass="btn btn-sm btn-danger"><i class="fa fa-remove"></i></asp:LinkButton>
                                                        </div>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
