<%@ Page Title="Import Leave Balance" Language="C#" MasterPageFile="~/UserMaster.master" AutoEventWireup="true" CodeFile="Import_Leave_Balance.aspx.cs" Inherits="Import_Leave_Balance" %>
                ...
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Import Leave Balance</h3>
                        </div>
                        <div class="box-body">
