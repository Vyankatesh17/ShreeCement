...
public partial class MonthlySchoolPresentReport : System.Web.UI.Page
{
    ...
    private void BindDataGridView()
    {
        try
        {
            ...
            string query = string.Format(@"SELECT       e.FName+' '+e.Lname AS EmpName , E.EmployeeNo,E.AccessCardNo,E.WorkLocation,E.CurPin , E.MachineID ,CONVERT(varchar, AL.AttendanceDate, 101) AS Date,
                        ...
                        WHERE     (E.IsActive=1) AND   (AL.Status IN ('P')) AND (CONVERT(date,AL.AttendanceDate) BETWEEN CONVERT(date,'{0}') AND CONVERT(date,'{1}'))  AND AL.TenantId='{2}'", txtFromDate.Text, txtToDate.Text,
