...
public partial class Monthly_Details_Report1 : System.Web.UI.Page
{
        ...
        try
        {
            ...
            string usertype = Session["UserType"].ToString();
                ...
                using (HrPortalDtaClassDataContext db = new HrPortalDtaClassDataContext())
                {
                    ...
                    lblHeader.Text = "OT And Total Duration Report for month of " + txtFromDate.Text + " - " + txtToDate.Text;
                string query = "";
