<%@ Page Title="" Language="C#" MasterPageFile="~/UserMaster.master" AutoEventWireup="true" CodeFile="Simple_MonthlyAttandanceReport.aspx.cs" Inherits="Simple_MonthlyAttandanceReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        ...
        function generateTableHeaders() {
            ...
            var fdatevalue = fromdate.val();
            var tdatevalue = todate.val();
            
            var fromDateDay = fdatevalue.Substring(9,2);
            var toDateDay = tdatevalue.Substring(9,2);

            var fday = fdatevalue.Day;
            var tday = tdatevalue.Day;
            for (var j = fday; j <= tday; j++) {
