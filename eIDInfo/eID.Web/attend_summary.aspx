<%@ Page Title="" Language="C#" MasterPageFile="~/UserMaster.master" AutoEventWireup="true" CodeFile="attend_summary.aspx.cs" Inherits="attend_summary" %>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td colspan="5" style="width: 25%">Employee Name : <b>
                                                                    ...
                                                                    <%# Eval("EmpName") %></b></td>
                                                                <td colspan="3" style="width: 25%">Employee No : <b><%# Eval("EmployeeNo") %></b></td>
                                                                <td colspan="5" style="width: 25%">Department : <b><%# Eval("DeptName") %></b></td>
