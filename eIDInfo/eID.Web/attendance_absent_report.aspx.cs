...
public partial class attendance_absent_report : System.Web.UI.Page
{
...
WHERE        (AL.Status IN ('A')) AND  (MONTH(AL.AttendanceDate) = {0}) AND (YEAR(AL.AttendanceDate) = {1})", ddlMonth.SelectedIndex, ddlYear.SelectedValue);
