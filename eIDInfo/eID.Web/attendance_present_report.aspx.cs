...
public partial class attendance_present_report : System.Web.UI.Page
{
...
WHERE        (AL.Status IN ('P', 'WP', 'HP', '½ P')) AND  (MONTH(AL.AttendanceDate) = {0}) AND (YEAR(AL.AttendanceDate) = {1})", ddlMonth.SelectedIndex, ddlYear.SelectedValue);
