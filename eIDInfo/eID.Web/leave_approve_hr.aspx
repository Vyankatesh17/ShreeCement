<%@ Page Title="Leave Approve By HR" Language="C#" MasterPageFile="~/UserMaster.master" AutoEventWireup="true" CodeFile="leave_approve_hr.aspx.cs" Inherits="leave_approve_hr" %>
                                        ...
                                        <asp:GridView ID="gvPendingLeaves" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered table-striped">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Action">
                                                    <ItemTemplate>
                                                        <div class="btn-group">
                                                            <asp:LinkButton ID="lbtnApprove" runat="server" CommandArgument='<%#Eval("LeaveApplicationId") %>' OnClick="lbtnApprove_Click" CssClass="btn btn-info btn-sm"><i class="fa fa-thumbs-up"></i> Approve/Reject <i class="fa fa-thumbs-down"></i></asp:LinkButton>
                                                        </div>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
