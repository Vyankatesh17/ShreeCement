<%@ Page Title="Employee List" Language="C#" MasterPageFile="~/UserMaster.master" AutoEventWireup="true"
    CodeFile="mst_employee_list_parabhani.aspx.cs" Inherits="mst_employee_list_parabhani" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            ...
                            <div class="box-tools">
                                ...
                                <%--<a href="device_download_persons_face.aspx" class="btn btn-box-tool btn-bitbucket">Download Faces & FingerPrints</a>--%>
                            </div>
                        </div>
                        <div class="box-body">
                            <div class="row">
                                ...
                                <asp:GridView ID="grd_Emp" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-striped table-responsive" AllowPaging="false"
                                    ...
                                    <Columns>
                                       ...
                                       <asp:TemplateField HeaderText="Emp Code">
                                        ...
                                        <asp:TemplateField HeaderText="DeActivate Date">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Action" HeaderStyle-CssClass="action-column">
                                            <ItemTemplate>
                                                ...
                                                <a href="employee_salary_settings.aspx?emp_id=<%#Eval("EmployeeId") %>" class="btn btn-yahoo btn-sm"><i class="fa fa-rupee"></i></a>
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                        ...
                        <div class="box-footer">
                            ...
                            <a href="javascript:void(0)" class="btn btn-sm btn-success btn-flat pull-right"><i class="fa fa-arrow-left"></i>&nbsp; active page no is
                                <asp:Label ID="lblPageNo" runat="server"></asp:Label></a>
                        </div>
                    </div>
                </div>
            </asp:View>
                                                ...
                                                <div class="box-body wb-border-blue">
                                                    ...
                                                    <div class="row">
                                                            ...
                                                            <div>
                                                                <div class="input-group">
                                                                    <div class="input-group-btn">
                                                                        <asp:DropDownList ID="ddlsalitude" runat="server" CssClass="form-control" Width="50px" style="padding: 5px;" >
                                                        ...
                                                        <div class="form-group col-lg-4">
                                                            ...
                                                            <div>
                                                                ...
                                                                <asp:Label ID="lblempid" runat="server" CssClass="lblclass" Text="Label" Visible="false"></asp:Label>
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-lg-6">
                                                            ...
                                                            <div>
                                                                ...
                                                                <asp:RequiredFieldValidator ControlToValidate="ddlCompany" InitialValue="0" ID="RequiredFieldValidator5" runat="server" CssClass="text-red" ErrorMessage="This field is required" Display="Dynamic" ValidationGroup="S"></asp:RequiredFieldValidator>
                                                            </div>
                                                        </div>
                                                         <div class="form-group col-lg-6">
                                                    ...
                                                    <div class="row">                                                      
                                                        ...
                                                        <div class="form-group col-lg-4">
                                                         ...
                                                         <div class="form-group col-lg-4">
                                                            <label class="control-label">Shift Group <span class="text-red">*</span></label>
                                                            <div>
                                                                <asp:DropDownList ID="ddlShiftGroup" runat="server" CssClass="form-control">
                                                                </asp:DropDownList>
                                                                <asp:RequiredFieldValidator ControlToValidate="ddlShiftGroup" ID="RequiredFieldValidator23" runat="server" CssClass="text-red" ErrorMessage="This field is required" Display="Dynamic" ValidationGroup="S"></asp:RequiredFieldValidator>
                                                                <asp:RequiredFieldValidator ControlToValidate="ddlShiftGroup" InitialValue="0" ID="RequiredFieldValidator24" runat="server" CssClass="text-red" ErrorMessage="This field is required" Display="Dynamic" ValidationGroup="S"></asp:RequiredFieldValidator>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">                                                        
                                                        ...
                                                        <div class="form-group col-lg-4">
                                                            ...
                                                            <asp:DropDownList ID="ddlGrade" runat="server" CssClass="form-control">
                                                                <asp:ListItem Selected="True" Value="">Select</asp:ListItem>
                                                                <asp:ListItem Value="E-2">E-2</asp:ListItem>
                                                                <asp:ListItem Value="E-3">E-3</asp:ListItem>
                                                                <asp:ListItem Value="M-1">M-1</asp:ListItem>
                                                                <asp:ListItem Value="M-2">M-2</asp:ListItem>
                                                                <asp:ListItem Value="M-3">M-3</asp:ListItem>
                                                                <asp:ListItem Value="S-1">S-1</asp:ListItem>
                                                                <asp:ListItem Value="S-2">S-2</asp:ListItem>
                                                                <asp:ListItem Value="S-3">S-3</asp:ListItem>
                                                                <asp:ListItem Value="S-4">S-4</asp:ListItem>
                                                                 <asp:ListItem Value="T-1">T-1</asp:ListItem>
                                                                <asp:ListItem Value="T-2">T-2</asp:ListItem>
                                                                <asp:ListItem Value="T-3">T-3</asp:ListItem>
                                                                <asp:ListItem Value="T-4">T-4</asp:ListItem>
                                                                <asp:ListItem Value="T-5">T-5</asp:ListItem>
                                                                <asp:ListItem Value="T-6">T-6</asp:ListItem>
                                                                <asp:ListItem Value="T-7">T-7</asp:ListItem>
                                                                <asp:ListItem Value="Z">Z</asp:ListItem>
                                                            </asp:DropDownList>
                                                        </div>
                                                         <div class="form-group col-lg-4">
                                                            <label class="control-label">Grade Sequence No.</label>
                                                        ...
                                                        <div class="form-group col-lg-6">
                                                           ...
                                                           <div class="form-group col-lg-6">
                                                            <label class="control-label">Password <span class="text-red">*</span></label>
                                                             <asp:TextBox ID="txtemppassword" CssClass="form-control" placeholder="Password" runat="server" MaxLength="20" />  
                                                               <%--<asp:RequiredFieldValidator ControlToValidate="txtemppassword" ID="RequiredFieldValidator23" runat="server" CssClass="text-red" ErrorMessage="Password is required" Display="Dynamic" ValidationGroup="S"></asp:RequiredFieldValidator>--%>
                                                        </div>                                                     
                                                         <div class="form-group col-lg-6">
                                                            <label class="control-label">Reliving Date</label>
                                                            <asp:TextBox ID="txtrelivingDate" TextMode="Date" runat="server" CausesValidation="True" CssClass="form-control"></asp:TextBox>
                                                        </div>

                                                        <div class="form-group col-lg-6">
                                                            <label class="control-label">Status</label>
                                                            <asp:DropDownList ID="ddlRelevingstatus" runat="server" CssClass="form-control">
                                                                <asp:ListItem Selected="True" Value="">Select</asp:ListItem>
                                                                <asp:ListItem Value="0">Working</asp:ListItem>
                                                                <asp:ListItem Value="1">Reliving</asp:ListItem>                                                               
                                                            </asp:DropDownList>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-sm-6">
                                                            <a href="#" class="btn btn-default" id="viewMod" onclick="modalShow();" data-backdrop="static" data-keyboard="false" data-target=".bs-example-modal-lg">Capture Photo</a>
                                                             <asp:Button ID="Button1" runat="server" CssClass="btn bg-blue-active" Text="Capture Device Picture"
                                                                OnClick="btnCatureDevicePicture_Click" />
                                                        </div>
                                                        <div class="form-group col-sm-6">
                                                            <asp:Image ID="image1" runat="server" Height="100px" Width="150px" Visible="False" />

                                                            <asp:Button ID="btnRemoveFace" runat="server" CssClass="btn bg-blue-active" Text="Remove Face" Visible="false"
                                                                OnClick="btnRemoveFace_Click" />
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="form-group col-sm-4">
                                                            <label class="control-label">Select Device<span class="text-danger">*</span></label>
                                                            <asp:DropDownList ID="ddlDevice" runat="server" CssClass="form-control"></asp:DropDownList>
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator18" runat="server" CssClass="text-red" ControlToValidate="ddlDevice" ErrorMessage="This field is required" Display="Dynamic" ValidationGroup="A"></asp:RequiredFieldValidator>
                                                            <asp:RequiredFieldValidator ControlToValidate="ddlDevice" InitialValue="0" ID="RequiredFieldValidator22" runat="server" CssClass="text-red" ErrorMessage="This field is required" Display="Dynamic" ValidationGroup="A"></asp:RequiredFieldValidator>
                                                        </div>
                                                        <div class="form-group col-sm-4">
                                                            <label class="control-label">Finger Number</label>
                                                            <asp:DropDownList ID="ddlfingerNo" runat="server" CssClass="form-control" AutoPostBack = "true" OnSelectedIndexChanged="ddlfingerNo_SelectedIndexChanged">
                                                        ...
                                                        <div class="form-group col-sm-4">
                                                            <asp:Button ID="btnfingerprint" runat="server" CssClass="btn bg-blue-active" Text="Capture Fingerprint"
                                                                OnClick="btnfingerprint_Click" />
                                                        </div>
                                                    </div>

                                                     <div class="row" id="divFingerprint" visible="false"  runat="server">
                                                       <div class="form-group col-sm-4" >
                                                            <label class="control-label" >Fingerprint Quality</label>
                                                            <asp:TextBox ID="txtFingerprintqty" runat="server" ReadOnly="true" CssClass="form-control"></asp:TextBox>
                                                        </div>
                                                         <div class="form-group col-sm-6">                                                             
                                                              <asp:Image ID="image2" runat="server"  Height="100px" Width="70px"  />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <script type="text/javascript">
        ...
        function changePageNo(no) {
            console.log(no);
            var labelP = $("#ContentPlaceHolder1_lblPageNo");
            labelP.innerHTML = no;
            var hiddenF = $("#ContentPlaceHolder1_hfPageNo");
            hiddenF.value = no;
            $("#ContentPlaceHolder1_btnPager").click();
        }
        ...
        function modalShow() {
            ...
            if ($("[id*=ContentPlaceHolder1_ddlCompany]").val() !== "0") {
                ...
                var Companytext = sel.options[sel.selectedIndex].text;


                var empid = document.getElementById("ContentPlaceHolder1_txtempID").value;
                var empFName = document.getElementById("ContentPlaceHolder1_txtfname").value;
                var empLName = document.getElementById("ContentPlaceHolder1_txtlname").value;

                var fullname = empid + "_" + empFName + "_" + empLName;
                console.log(Companytext);

                // here 1 is online device and 0 for offline device 
                var url = "capture_employee_photo.aspx?cId=" + Companytext + "&EmployeeId=" + fullname;
                console.log(url);
