<%@ Page Title="OD Approve By HR" Language="C#" MasterPageFile="~/UserMaster.master" AutoEventWireup="true" CodeFile="out_door_approve_hr.aspx.cs" Inherits="out_door_approve_hr" %>
                ...
                <ContentTemplate>
                    <asp:MultiView ID="MultiView1" ActiveViewIndex="0" runat="server">
                        <asp:View ID="View1" runat="server">
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Pending OD</h3>
                                </div>
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-lg-6">
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView ID="gvPendingLeaves" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered table-striped">
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="TravelReason" HeaderText="Travel Reason" />
                                                <asp:BoundField DataField="ManagerStatus" HeaderText="Status" />
                                                <asp:TemplateField HeaderText="Action">
                                                    <ItemTemplate>
                                                        <div class="btn-group">
                                                            <asp:LinkButton ID="lbtnApprove" runat="server" CommandArgument='<%#Eval("OddId") %>' OnClick="lbtnApprove_Click" CssClass="btn btn-info btn-sm"><i class="fa fa-thumbs-up"></i> Approve/Reject <i class="fa fa-thumbs-down"></i></asp:LinkButton>
                                                        </div>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                        ...
                        <asp:View ID="View2" runat="server">
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Approve / Reject OD</h3>
                                </div>
                                <div class="box-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="control-label">Travel Reason</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="control-label">Manager Comment</label>
                                                <asp:TextBox ID="lblManagerComment" runat="server" CssClass="form-control" disabled></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
