<%@ Page Title="Roster Info" Language="C#" MasterPageFile="~/UserMaster.master" AutoEventWireup="true" CodeFile="rosterMaster.aspx.cs" Inherits="rosterMaster" %>
                                    ...
                                    <div class="col-md-12">
                                        <asp:Panel ID="pnl" runat="server" DefaultButton="btnsubmit">
                                            <div class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <asp:DataList ID="datalistdisplay" runat="server" RepeatDirection="Horizontal" GridLines="Both" RepeatColumns="11">
                                                            <ItemTemplate>
